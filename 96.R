...
attr(EXP96$Table, "label") <- "Table in Part 3"
attr(EXP96$Global, "label") <- "global item code"
...
attr(IND96$occupationalst, "label") <- "employment status"
...
attr(HH96$income_nm_homemade, "label") <- "Non-monetary income from home production"
